"""
https://appen.atlassian.net/browse/QED-1406
Create 1 job, 1 unit/page (1000 frames), ~200s to complete a page of work.
...
with se.session(teardown=False) as session_id:
    ...
    # 100k units / 200 units/minute = 500 minutes = 8h20m
    se.wait(500*60)  # wait units to become judgeable
