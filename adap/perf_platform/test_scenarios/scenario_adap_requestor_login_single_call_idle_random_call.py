...
with se.session(f"API gateway [{ENV}]", teardown=True) as session_id:
    ...
    data_source_env_paths = {
        ...
        'integration': 'adap/perf_platform/test_data/integration_requestor_emails_new.csv'
    }
    ...
    locust_1 = {
        ...
        'filename': 'adap/perf_platform/locust_adap_requestor_login_single_call_idle_random_call_test.py',
