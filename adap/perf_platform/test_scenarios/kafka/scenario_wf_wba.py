"""
https://appen.atlassian.net/browse/QED-2586
"""
...
with se.session(teardown=False) as session_id:
    ...
    _consumerconfig = {
        ...
        'KAFKA_TEST_TOPICS': 'builder.units.from.external'
        # 'KAFKA_TEST_TOPICS': 'wfp.datalines.from.external.to.workflows',
        #                        'wfp.builder.adapter.dead.letters',
    ...
    rs_config = {
      ...
      'command': 'python',
      'ENV': ENV,
      'args': ['adap/perf_platform/kafka_consumers_without_key.py'],
      'num_replicas': 3,
      'cmap_data': {
          **_consumerconfig
      }
